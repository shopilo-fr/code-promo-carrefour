#!/usr/bin/env python3
"""
Recuperation des codes promo Carrefour depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/carrefour.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/carrefour.fr"
STORE_NAME = "Carrefour"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Carrefour depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-carrefour)"
    }
    try:
